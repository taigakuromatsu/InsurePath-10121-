          ...
          <mat-expansion-panel>
            ...
            <div class="info-body">
              ...
              <ul class="info-list">
                ...
                <li>
                  <strong>現在の就業状態・就業状態のメモ</strong><br />
                  管理用の情報です。保険料計算には直接使用されません（免除月の登録とは別管理です）。
                </li>
                <li>
                  <strong>支給形態・支給サイクル・補足メモ（給与情報）</strong><br />
                  管理用の情報です。保険料計算には直接使用されません。報酬月額を入力する場合は、支給形態と支給サイクルも必須です。
                </li>
                <li>
                  <strong>報酬月額（円）</strong><br />
                  標準報酬月額を概算するための月額給与です。標準報酬履歴フォームの「報酬月額から概算して標準報酬を自動入力」ボタンで標準報酬を自動計算する際に使用されます。
                </li>
                <li>
                  <strong>標準報酬履歴</strong><br />
                  標準報酬の変更履歴を管理します。標準報酬履歴フォームで、適用開始年月・健康保険の等級・標準報酬・厚生年金の等級・標準報酬を登録・編集できます。「履歴に追加」ボタンで標準報酬履歴に追加すると、その月以降の保険料計算で使用されます。月次保険料・賞与保険料の計算では、対象年月に適用される履歴（appliedFromYearMonth <= 対象年月 の最新）が使用されます。
                </li>
                <li>
                ...
                <li>
                  <strong>被保険者記号・被保険者番号・厚生年金番号</strong><br />
                  管理用の情報です。保険料計算には直接使用されません。
                </li>
              </ul>

              <h4 style="margin-top: 20px; margin-bottom: 12px; font-size: 1rem; font-weight: 600;">給与振込口座情報</h4>
              <ul class="info-list">
                <li>
                  <strong>金融機関名・金融機関コード・支店名・支店コード・口座種別・口座番号・名義・名義カナ</strong><br />
                  管理用の情報です。保険料計算には直接使用されません。
                </li>
              </ul>
