...
export class CloudMasterService {
  ...
  private getHealthCollectionRef() {
    return this.inCtx(() => collection(this.firestore, 'cloudHealthRateTables'));
  }

  private getCareCollectionRef() {
    return this.inCtx(() => collection(this.firestore, 'cloudCareRateTables'));
  }

  private getPensionCollectionRef() {
    return this.inCtx(() => collection(this.firestore, 'cloudPensionRateTables'));
  }
